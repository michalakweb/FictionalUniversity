...
class Search {
				...
				<div class="row">
					...
					<div class="one-third">
						<h2 class="search-overlay__section-title">Programs</h2>
							...
							${results.programs.length ? '<ul class="link-list min-list">' : '<p>No matches.</p>'}
					...
					<div class="one-third">
						<h2 class="search-overlay__section-title">Campuses</h2>
							...
							${results.generalInfo.length ? '</ul>' : '' }
								...
								${results.events.length ? '' : `<p>No events match that search. <a href="${universityData.root_url}/event">View all events</a></p>`}
	...
	closeOverlay() {
		...
		document.querySelector('body').removeAttribute('class', "body-no-scroll");
		this.isOverlayOpen = false;
	}
